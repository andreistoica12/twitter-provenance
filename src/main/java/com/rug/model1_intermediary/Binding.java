...
import com.rug.model1_intermediary.DataClass.Reaction;
...
public class Binding {
    ...
    public static void main(String[] args) throws URISyntaxException {
        ...
        Path inputFilePath = Paths.get(currentWorkingDirectory, "src", "main", "java", "com", "rug", "model1_intermediary", "data.json");
        ...
        try {
            ...
            DataClass data = objectMapper.readValue(new File(inputFilePathString), DataClass.class);
